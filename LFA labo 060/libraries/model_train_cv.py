...
class ModelTrain(object):
    ...
    def __init__(self, array_index_train_test, X_train, y_train, number_rule, var_per_rule, classifier_trefle, path_save_results, experience_name, weight_actual=1.0, path_save_results_values = 'values.csv'):
        ## 0: param_a value 1: param_b value 2: cv_number 3:tn 4:fp 5:fn 6:tp 
        self.results_scores_line = np.zeros([8])
        self.array_list_files_name = []
        self.results_scores_array = [np.zeros([8])]
        ...
        self.weight_actual = weight_actual
    ...
    def saveIntoDataFrame(self, tn, fp, fn, tp):
        ...
        self.results_scores_line[4] = tn
        self.results_scores_line[5] = fp
        self.results_scores_line[6] = fn
        self.results_scores_line[7] = tp
    ...
    def TrainSystem(self, x_train, y_train, x_test, y_test, cv_number):
        ...
        name_model = self.experience_name + "_weigh_actual_" + str(self.weight_actual) + "_conf_A_CV_" + str(cv_number) + "_rule_" + str(self.number_rule) + "_var_per_rule_" + str(self.var_per_rule) + ".ftt"
    ...
    def execute_cv(self):
        ...
        for train_index, test_index in array_index_train_test_copy:
            ...
            self.results_scores_line[2] = self.weight_actual
            self.results_scores_line[3] = cv_number
    ...
    def saveResultsIntoCSVFile(self, path_to_save:str, path_directory_models:str):
        ...
        datafram_results = pd.DataFrame(results_scores_array ,columns=['param_a', 'param_b','weight', 'CV_num', 'tn', 'fp','fn','tp','file_name'])
